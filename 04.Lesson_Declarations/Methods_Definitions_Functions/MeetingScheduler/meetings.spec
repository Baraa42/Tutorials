...
definition meetingStarted(env e, uint256 meetingId) returns bool = e.block.timestamp > getStartTimeById(meetingId) && getStartTimeById(meetingId) > 0 &&  getEndTimeById(meetingId) > getStartTimeById(meetingId)  && getOrganizer(meetingId) != 0 && getStateById(meetingId) == 2;
definition meetingEnded(env e, uint256 meetingId) returns bool = getStartTimeById(meetingId) > 0 && e.block.timestamp > getEndTimeById(meetingId)  && getEndTimeById(meetingId) > getStartTimeById(meetingId)  && getOrganizer(meetingId) != 0 && getStateById(meetingId) == 3;
